...
3. [Security, observability, testing, rollout](security-observability-testing-rollout.md) + [ADR-0043](adr/0043-observability-dashboard-deployment.md) (how the Grafana dashboards deploy; most read Postgres, not Prometheus)
