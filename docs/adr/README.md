...
| [0054](0054-review-model-and-provider-selection.md) | Stay on MiniMax-M2.7 (FP8) on DeepInfra for the review agent — cost floor at best quant; "faster+smarter" only on Cerebras (declined); reopen triggers documented | Accepted |
