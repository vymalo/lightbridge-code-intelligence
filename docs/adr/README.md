...
| [0067](0067-skip-auto-review-on-bot-authored-prs.md) | Skip the automatic fast review when the PR author is a bot (`user.type == "Bot"` + `[bot]` backstop, fail open); `@mention` deep review untouched; `review.skipBotAuthoredPrs` defaults on | Accepted |
